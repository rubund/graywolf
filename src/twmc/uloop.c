...
void make_movebox() 
{
    ...
    old_aposG = (MOVEBOXPTR *) 
	    Ysafe_malloc_clear( maxtiles * sizeof(MOVEBOXPTR) ); 
    for( i = 0; i< maxtiles ; i++ ){
	old_aposG[i] = (MOVEBOXPTR) Ysafe_malloc_clear( sizeof(MOVEBOX) ) ;
    ...
    new_aposG = (MOVEBOXPTR *) 
	    Ysafe_malloc_clear( maxtiles * sizeof(MOVEBOXPTR) ); 
    for( i = 0; i< maxtiles ; i++ ){
	new_aposG[i] = (MOVEBOXPTR) Ysafe_malloc_clear( sizeof(MOVEBOX) ) ;
    ...
    old_bposG = (MOVEBOXPTR *) 
	    Ysafe_malloc_clear( maxtiles * sizeof(MOVEBOXPTR) ); 
    for( i = 0; i< maxtiles ; i++ ){
	old_bposG[i] = (MOVEBOXPTR) Ysafe_malloc_clear( sizeof(MOVEBOX) ) ;
    ...
    new_bposG = (MOVEBOXPTR *) 
	    Ysafe_malloc_clear( maxtiles * sizeof(MOVEBOXPTR) ); 
    for( i = 0; i< maxtiles ; i++ ){
	new_bposG[i] = (MOVEBOXPTR) Ysafe_malloc_clear( sizeof(MOVEBOX) ) ;
